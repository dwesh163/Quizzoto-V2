export default function Header({}) {
	return (
		<header className="bg-white">
				...
				<div className="flex justify-between items-center w-full">
					...
					<div className="hidden xl:block xl:w-1/3">
						<div className="flex items-center justify-end">
							<a className="inline-block py-2 px-4 text-sm leading-5 text-blue-50 bg-blue-500 hover:bg-blue-600 font-medium focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md" href="#">
								Log In
							</a>
						</div>
					</div>
			...
			<div className="navbar-menu fixed top-0 left-0 z-50 w-full h-full bg-coolGray-900 bg-opacity-50 hidden">
						...
						<div className="flex flex-col justify-between h-full">
							...
							<div className="flex flex-wrap">
								<div className="w-full">
									<a className="inline-block py-2 px-4 w-full text-sm leading-5 text-white bg-blue-500 hover:bg-blue-600 font-medium text-center focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 rounded-md" href="#">
										Log In
									</a>
								</div>
							</div>

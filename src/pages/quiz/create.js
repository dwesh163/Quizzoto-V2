			...
			<main>
				...
				<div className="flex md:bg-[#fcfcfc] bg-white flex-col max-w-6xl px-2 mx-auto items-center justify-center md:px-6 lg:px-8 mt-20">
					<div className="w-full mx-auto px-4 md:px-auto md:mt-12">
						{!loading ? (
							<>
								<h3 class="text-3xl font-bold">Create Quizz</h3>
								...
								{quizzData.questions.map((question, index) => (
									<div key={index}>
										<div className="flex gap-4 mb-6 mt-4">
											...
											/>
											<select
												className="border border-gray-300 rounded-md p-2 mb-2 w-1/6"
												value={question.type}
												onChange={(event) => {
													const newQuestions = [...quizzData.questions];
											...
											<div class="inline-flex sm:px-28 px-10 items-center justify-center w-full">
												...
												<div class="absolute px-4 -translate-x-1/2 bg-white left-1/2">
													<button
														...
														<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#fff" class="bi bi-plus w-6 h-6" viewBox="0 0 16 16">

				...
				{isLoading ? (
					<div className="sm:h-[calc(100vh-140px)] h-[calc(100vh-110px)] max-w-6xl mt-[5rem] sm:mt-24 pb-5 mx-auto md:px-6 lg:px-8 bg-white md:bg-[#fcfcfc]">
						...
						<div className="flex justify-center w-full h-full sm:px-5 md:px-24 gap-5">
							<div className="flex mt-12 items-center justify-center relative w-full p-5 bg-white h-[30rem] md:bg-card-texture bg-no-repeat bg-top md:rounded-2xl md:shadow-xl">
					...
					<div className="sm:h-[calc(100vh-140px)] h-[calc(100vh-110px)] max-w-6xl mt-[5rem] sm:mt-24 pb-5 mx-auto md:px-6 lg:px-8 bg-white md:bg-[#fcfcfc]">
						...
						{quiz?.starter && (
							<div className="flex justify-center w-full h-full sm:px-5 md:px-24 gap-5">
								<div className="relative w-full p-5 mt-12 min-h-[30rem] h-fit bg-white md:bg-card-texture bg-no-repeat bg-top md:rounded-2xl md:shadow-xl">
									<div>
									...
									<div className="flex justify-center flex-col mt-12 gap-4">
					...
					<div className="sm:h-[calc(100vh-140px)] h-[calc(100vh-110px)] max-w-6xl mt-[5rem] sm:mt-24 pb-5 mx-auto md:px-6 lg:px-8 bg-white md:bg-[#fcfcfc]">
						<Menu title={quiz.title} />
						<div className="flex justify-center w-full h-full sm:px-5 md:px-24 gap-5">
							<div className="relative w-full p-5 bg-white mt-12 min-h-[30rem] h-fit md:bg-card-texture bg-no-repeat bg-top md:rounded-2xl md:shadow-xl">
